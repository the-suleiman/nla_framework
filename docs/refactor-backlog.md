...
- **Single SPA bundle (Quasar 2 only)** — one frontend; no project config to choose another stack or Quasar version. Documented in [architecture.md](architecture.md) and [generated-app.md](generated-app.md). Bumping the CLI stack is a framework change in [`templates/project/webClient/package.json`](../templates/project/webClient/package.json) and [`templates/project/webClient/quasar.config.js`](../templates/project/webClient/quasar.config.js).
